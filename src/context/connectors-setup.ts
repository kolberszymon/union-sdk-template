...
function mapToBlockchainWallet<O, C extends ProviderResult>(
  provider: AbstractConnectionProvider<O, C>
): ConnectionProvider<O, BlockchainWallet> {
...
const mew = mapToBlockchainWallet(
...
const beacon = mapToBlockchainWallet(
...
const fcl = mapToBlockchainWallet(
...
const torus = mapToBlockchainWallet(
...
const walletlink = mapToBlockchainWallet(
  ...
  async getValue(): Promise<string | undefined> {
    const value =
      typeof window !== "undefined"
        ? localStorage.getItem("saved_provider")
        : null;
